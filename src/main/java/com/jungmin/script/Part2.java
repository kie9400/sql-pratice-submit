...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "insert into users(username,email,password) values('럭키','sw8865@naver.com','sw8865')";
  ...
  */
  public static final String PART2_7 = "select p.title, u.username " +
          "from posts as p left join users as u on p.user_id = u.user_id";
  ...
  */
  public static final String PART2_13 = "select b.name " +
  ...
  */
  public static final String PART2_15 = "select count(c.content) as CommentCount from comments as c " +
  ...
  */
  public static final String PART2_16 = "select u.username, count(c.content) as CommentCount from comments as c " +
  ...
  */
  public static final String PART2_17 = "select b.name, count(b.board_id) as PostCount from boards as b " +
  ...
  */
  public static final String PART2_19 = "select b.name, avg(length(p.content)) as AvgLength from boards as b " +
          "join posts as p on b.board_id = p.board_id " +
          "where p.content is not null group by b.name";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-20. 각 tag의 name과 해당 tag가 달린 post의 개수 (컬럼명: PostCount)를 출력하기위 한 SQL을 작성해주세요.
